                            ...
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                ...
                                <form action="{{ route('account.processRegister' )}}" method="POST">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" id="first_name" placeholder="Firstname">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" id="last_name" placeholder="Lastname">
